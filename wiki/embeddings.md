...
Every embedding model GAISe can drive, what each one needs to perform well, and the practices that hold across all of them. Facts are from the official model pages audited **2026-09-04**; numbers you cannot afford to get wrong (dimensions, token limits, task types) carry their source.
...
<!-- Generated by `cargo run -p gaise-client --example embedding_matrix --all-features`; registry audited 2026-09-04 -->
