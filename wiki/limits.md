...
<!-- Generated by `cargo run -p gaise --example limits_matrix`; registry audited 2026-09-12 -->
...
| `gpt-image-2` | active | — | — | — | — | — | — |  |
| `gpt-image-2.5-sunburst` | active | — | — | — | — | — | — |  |
| `gpt-image-2.5-flare` | active | — | — | — | — | — | — |  |
| `gpt-live-1` | active | — | — | — | — | — | — | Delegates reasoning and tools to a backend Responses model (session.delegation.type = responses) or to the client; streaming and function calling, no structured outputs. No context window or max output is documented. |
| `gpt-5.6-cyber` | active | — | 400,000 | 128,000 | — | — | — | 400K context (not the 1.05M of the GPT-5.6 family); 272K max input. |
| `gpt-daybreak-*` | active | — | — | — | — | — | — |  |
| `gpt-rosalind-research` | active | — | — | — | — | — | — | Billing starts 2026-10-05 ($5 input, $0.50 cached, $25 output per 1M; no cache-write pricing). The catalog card links only to the pricing page, so endpoints, context window, effort values, and tool support are undocumented. |
...
| `gemini-omni-flash-preview` | preview | — | 131,072 | 57,920 | — | — | — |  |
| `gemini-3.5-live-translate-preview` | preview | — | — | — | — | — | — | Text transcript output; no thinking, tools, or system instructions. |
...
| `openai.gpt-6-astra` | active | IS | 1,050,000 | 128,000 | — | — | — | Guardrails and application inference profiles on Converse only; structured outputs, count tokens, and server-side tool use not supported; prompt caching on the Responses API only. Pricing splits at 272K input; quotas are TPM with a 10x output burndown. |
| `openai.gpt-daybreak-blue-5.6-sol` | active | — | 1,000,000 | — | — | — | — |  |
...
| `xai.grok-4.3` | active | — | 1,000,000 | — | — | — | — | Priority (1.75x) and Flex (0.5x) tiers; structured outputs supported. Max output tokens and image input are not stated on the card. |
...
| `anthropic.claude-3-haiku-20240307-v1:0` | retired | — | 200,000 | 4,096 | — | — | — |  |
...
| `laguna-xs-2.1:*` | active | IS | 262,144 | — | — | — | — |  |
| `glm-5.3:*` | active | IS | 1,048,576 | — | — | — | — | Z.ai GLM-5.3, cloud-only glm-5.3:cloud (open weights 2026-08-28); 1M context; reasoning_effort low/high/max (default max) and clear_thinking. |
| `glm-5.3-flash:*` | active | IS | 1,048,576 | — | — | — | — | GLM-5.3 Flash, 320B-A18B natively multimodal (MIT), cloud-only glm-5.3-flash:cloud; 1M context; reasoning is always on with effort low/high/max per request, so think: false is not expected to disable it. |
| `deepseek-v4.1-flash:*` | active | IS | 1,048,576 | — | — | — | — | DeepSeek V4.1 Flash (2026-09-10), 763B MoE on a 552B backbone with native vision, cloud-only deepseek-v4.1-flash:cloud; 1M context; library badges vision, tools, thinking; no think levels documented. |
| `kimi-k3:*` | active | IS | 1,048,576 | — | — | — | — | Moonshot Kimi K3, 2.81T-parameter open-weight multimodal agentic model, cloud-only kimi-k3:cloud (listed 2026-08); 1M context; no think levels documented. |
| `granite4.2:*` | active | IS | 131,072 | — | — | — | — | IBM Granite 4.2 3b/8b/30b (Apache 2.0, 2026-08); 128K context; tool use, structured JSON output, and thinking (enable_thinking true/false, reasoning_effort low/high, default high). |
| `ornith-1.5:*` | active | IS | 262,144 | — | — | — | — | Ornith 1.5 9b/35b/397b (2026-08); 256K context; vision badge only (no tools or thinking badge, unlike the older ornith family). |
