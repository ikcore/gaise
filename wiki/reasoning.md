...
Bedrock Nova forwards the canonical name because AWS documents `low`/`medium`/`high` only; other names surface as provider validation errors rather than silent substitutions. The Ollama column shows GPT-OSS; the other level families as of 2026-09-12 are GLM 5.3 (`low`/`high`/`max`, `medium` clamps to `high`) and Granite 4.2 (`low`/`high`), and every other tag gets a boolean.
...
<!-- Generated by `cargo run -p gaise-client --example reasoning_matrix --all-features`; registry audited 2026-09-12 -->
...
| `gpt-rosalind-research` | `reasoning_effort: none` | omitted (model default) | `reasoning_effort: minimal` | `reasoning_effort: low` | `reasoning_effort: medium` | `reasoning_effort: high` | `reasoning_effort: xhigh` | `reasoning_effort: max` | `reasoning_effort: max` |
...
| `openai.gpt-6-astra` | n/a | n/a | n/a | n/a | n/a | n/a | n/a | n/a | n/a |
| `openai.gpt-daybreak-blue-5.6-sol` | n/a | n/a | n/a | n/a | n/a | n/a | n/a | n/a | n/a |
...
| `xai.grok-4.3` | n/a | n/a | n/a | n/a | n/a | n/a | n/a | n/a | n/a |
...
| `laguna-xs-2.1:*` | `think: false` | `think: true` | `think: true` | `think: true` | `think: true` | `think: true` | `think: true` | `think: true` | `think: true` |
| `glm-5.3:*` | `think: false` | `think: true` | `think: "low"` | `think: "low"` | `think: "high"` | `think: "high"` | `think: "max"` | `think: "max"` | `think: "max"` |
| `glm-5.3-flash:*` | `think: false` | `think: true` | `think: "low"` | `think: "low"` | `think: "high"` | `think: "high"` | `think: "max"` | `think: "max"` | `think: "max"` |
| `deepseek-v4.1-flash:*` | `think: false` | `think: true` | `think: true` | `think: true` | `think: true` | `think: true` | `think: true` | `think: true` | `think: true` |
| `kimi-k3:*` | `think: false` | `think: true` | `think: true` | `think: true` | `think: true` | `think: true` | `think: true` | `think: true` | `think: true` |
| `granite4.2:*` | `think: false` | `think: true` | `think: "low"` | `think: "low"` | `think: "high"` | `think: "high"` | `think: "high"` | `think: "high"` | `think: "high"` |
...
- Family tables: `openai_chat_rules` ([OpenAI](vendor-openai.md#parameter-compatibility-audited-2026-09-12)), `claude_family_rules` ([Anthropic](vendor-anthropic.md#parameter-compatibility-audited-2026-09-12)), `claude_rules` ([Bedrock](vendor-bedrock.md#parameter-compatibility-audited-2026-09-12)), `thinking_levels_for` / `thinking_budget_for` ([Gemini](vendor-gemini.md#parameter-compatibility-audited-2026-09-12), [Vertex AI](vendor-vertexai.md#parameter-compatibility-audited-2026-09-12)), `ollama_think` ([Ollama](vendor-ollama.md)).
